    ...
    <div class="w-screen relative overflow-hidden min-h-screen flex items-center justify-center p-2">
        <div
            ...
            <div class="w-full px-3 md:px-7 py-20 relative">
                <form action="" class="userRegistration"  onsubmit="userRegistration();return false;">
                    <div class="card">
                        ...
                        <p class="mt-[20px] text-center text-md">Already have an account? <a href="{{route('page.login')}}"
                                class="font-fold text-cyan-800">Signin</a></p>
                    </div>
                </form>
